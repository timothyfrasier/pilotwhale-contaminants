This repository contains the raw data, as well as all of the code required to generate the figures in the associated paper, as well as for all of the statistical analyses reported therein.
